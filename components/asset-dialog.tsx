...
interface AssetDialogProps {
  ...
  asset: Asset | null
  onSave: (asset: Omit<Asset, "id" | "currentValue" | "lastUpdated">) => void
}
...
export function AssetDialog({ open, onOpenChange, asset, onSave }: AssetDialogProps) {
  ...
  useEffect(() => {
    if (asset) {
      setFormData({
        ...
        ceilingPrice: asset.ceilingPrice?.toString() || "",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({
      ...
      ceilingPrice: formData.ceilingPrice ? Number(formData.ceilingPrice) : undefined,
        ...
        {showSearchOnly ? (
          ...
          <form onSubmit={handleSubmit} className="custom-scrollbar pr-2 max-h-[70vh] overflow-y-auto">
            <div className="grid gap-4 py-4">
              ...
              {/* Parâmetros das estratégias de aporte (ceiling / waterfall) — opcionais */}
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <Label htmlFor="ceilingPrice" className="text-foreground font-medium">Preço-Teto (R$)</Label>
                  <Input
                    id="ceilingPrice"
                    type="number"
                    step="0.01"
                    ...
                    placeholder="Opcional (estratégia teto)"
                    className="bg-muted border-border"
                  />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    placeholder="Opcional (1 = 1ª na cascata)"
                    className="bg-muted border-border"
                  />
                </div>
              </div>
