                        ...
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                {assets.length === 0 ? (
                                    ...
                                    assets.map((asset) => (
                                        <AssetCard key={asset.id} asset={asset} totalNetWorth={totalNetWorth} onEdit={() => openEditDialog(asset)} onDelete={() => handleDeleteAsset(asset.id)} isPrivate={settings.isPrivate} />
                                    ))
                                )}
                            </div>
                        </div>
